# Zurich QA Automation Assessment — Selenium + Java + TestNG
...
# Run specific test
- mvn clean test -DsuiteXmlFile=src/test/resources/web-test.xml
...
- Uses PreparedStatement class to compose query and 
